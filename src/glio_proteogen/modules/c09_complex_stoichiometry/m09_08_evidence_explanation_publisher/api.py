...
def create_app(service: M0908Service | None = None) -> FastAPI:  # noqa: C901
    ...
    app.add_middleware(
        ...
        max_bytes=M0908_MAX_CANONICAL_REQUEST_BYTES,
        result_max_bytes=M0908_MAX_CANONICAL_RESULT_BYTES,
    )
