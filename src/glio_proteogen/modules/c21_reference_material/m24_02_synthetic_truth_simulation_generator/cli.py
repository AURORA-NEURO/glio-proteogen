...
class M2402CliError(typer.BadParameter):
    """Sanitized M24-02 command-line validation error."""
...
def _read_request(path: Path) -> GenerateBiomarkerPanelSyntheticTruthRequest:
    try:
        ...
        raise M2402CliError("input must satisfy the strict M24-02 request contract") from error  # noqa: TRY003
...
def export_schema(
    ...
    """Export one strict provisional M24-02 contract schema."""
