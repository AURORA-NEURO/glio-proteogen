...
def _parse_object(body: bytes) -> dict[str, Any]:
    try:
        value = strict_json_loads(body, max_bytes=M2404_MAX_CANONICAL_RESULT_BYTES)
...
def create_app(service: M2404Service | None = None) -> FastAPI:
    ...
    app.add_middleware(
        ...
        max_bytes=M2404_MAX_CANONICAL_REQUEST_BYTES,
        result_max_bytes=M2404_MAX_CANONICAL_RESULT_BYTES,
    )
