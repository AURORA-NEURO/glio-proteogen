...
from glio_proteogen.modules.c07_copy_number.m07_02_representation_feature_constructor.service import (  # noqa: E501
    M0702Service,
)
...
def _read(path: Path) -> bytes:
    try:
        body = read_bounded(path, max_bytes=M0702_MAX_CANONICAL_REQUEST_BYTES)
