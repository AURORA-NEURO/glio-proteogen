"""Stateless application seam for provisional M07-02."""

from __future__ import annotations

from typing import TYPE_CHECKING

from .engine import BuiltRepresentation, M0702RepresentationEngine
...
class M0702Service:
    ...
    def __init__(self) -> None:
        self._engine = M0702RepresentationEngine()

    @staticmethod
    def validate_request(
        request: object,
    ) -> ConstructProteotypeAnalysisRepresentationRequest:
        return M0702RepresentationEngine.validate_request(request)
