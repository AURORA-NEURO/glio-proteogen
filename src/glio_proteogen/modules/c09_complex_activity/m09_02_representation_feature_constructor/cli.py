...
from glio_proteogen.modules.c09_complex_activity.m09_02_representation_feature_constructor.engine import (  # noqa: E501
    M0902AuthorizationError,
)
from glio_proteogen.modules.c09_complex_activity.m09_02_representation_feature_constructor.service import (  # noqa: E501
    M0902Service,
)
...
def _read(path: Path) -> bytes:
    try:
        body = read_bounded(path, max_bytes=M0902_MAX_CANONICAL_REQUEST_BYTES)
