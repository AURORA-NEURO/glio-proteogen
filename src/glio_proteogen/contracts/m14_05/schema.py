...
def contract_json_schema(name: ContractName) -> dict[str, object]:
    ...
    schema["x-glio-contract"] = {
        ...
        "dossierSlice": M1405_DOSSIER_SLICE,
        "requirementSha256": M1405_REQUIREMENT_SHA256,
        ...
        "robustEstimator": "damped_huber_temporal_coordinate_descent",
        "bootstrapReplicatesDefault": M1405_DEFAULT_BOOTSTRAP_REPLICATES,
        "bootstrapReplicatesMaximum": M1405_MAX_BOOTSTRAP_REPLICATES,
        "legacyMetadataReplayPath": "compatibility_only",
    }
    if name == "request":
