...
symbols are provisional pending Scientific engineering owner confirmation.
"""
...
M1404_OUTPUT_MEDIA_TYPE: Final = "application/vnd.glio-proteogen.m11-04+json"
M1404_M1401_RESULT_MEDIA_TYPE: Final = "application/vnd.glio-proteogen.m11-01+json"
...
class ProteinSubtypeMechanismInferenceResult(FrozenModel):
    ...
    output_type: Literal["protein_subtype_mechanism_inference"] = "protein_subtype_mechanism_inference"
...
def expected_provenance(
    ...
    return ProvenanceRecord(
        ...
        module_id=M1404_MODULE_ID,
        module_version=M1404_CONTRACT_VERSION,
