...
SCHEMA_ID_PREFIX: Final = (
    "urn:aurora-neuro:glio-proteogen:GLIO-PROTEOGEN-M09-07:0.1.0-provisional"
)
...
def contract_json_schema(name: ContractName) -> dict[str, object]:
    ...
    schema["x-glio-contract"] = {
        ...
        "gate": M0907_GATE,
        "strict": True,
        "provisionalAbi": M0907_PROVISIONAL_ABI,
        ...
        "uncertaintyInputMediaType": M0907_UNCERTAINTY_MEDIA_TYPE,
