"""Canonical projections for the provisional M09-06 contract spine."""
...
def normalized_request(value: BaseModel | dict[str, Any]) -> dict[str, Any]:
    ...
    observations = document.get("uncertainty_observations")
    if isinstance(observations, list):
        document["uncertainty_observations"] = sorted(
            observations,
