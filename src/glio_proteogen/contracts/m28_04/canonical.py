"""Canonical projections for the provisional M28-04 contract spine."""
...
def result_identifier(request_digest: Sha256Digest) -> str:
    """Derive the stable gateway result identifier from the exact request."""

    return "gateway.m2804." + request_digest.removeprefix("sha256:")
