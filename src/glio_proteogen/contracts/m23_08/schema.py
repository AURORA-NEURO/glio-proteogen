"""JSON Schema 2020-12 exports for provisional M23-08 contracts."""
...
from glio_proteogen.contracts.m23_08.v1 import (
...
SCHEMA_ID_PREFIX: Final = "urn:aurora-neuro:glio-proteogen:GLIO-PROTEOGEN-M23-08:0.1.0-provisional"
CONTRACT_VERSION: Final = M2308_CONTRACT_VERSION
...
_CONTRACTS: Final = {
    ...
    "output": VariantPeptideEvidenceGateResult,
...
def contract_json_schema(name: ContractName) -> dict[str, object]:
    """Return one strict, metadata-only provisional M23-08 schema."""

    schema = TypeAdapter(_CONTRACTS[name]).json_schema(mode="validation")
    schema["$schema"] = "https://json-schema.org/draft/2020-12/schema"
    schema["$id"] = f"{SCHEMA_ID_PREFIX}:{name}"
    schema["x-glio-contract"] = {
        "moduleId": M2308_MODULE_ID,
        "dossierSha256": M2308_DOSSIER_SHA256,
        "dossierSlice": M2308_DOSSIER_SLICE,
        "contractVersion": CONTRACT_VERSION,
        "owner": M2308_OWNER,
        "safetyClass": M2308_SAFETY_CLASS,
        "gate": M2308_GATE,
        "strict": True,
        "provisionalAbi": M2308_PROVISIONAL_ABI,
        ...
        "parentTarget": M2308_PARENT,
        "unsupportedToNegative": False,
        "outputMediaType": M2308_OUTPUT_MEDIA_TYPE,
    ...
    if name == "request":
        schema["x-glio-contract"]["maxRequestBytes"] = M2308_MAX_CANONICAL_REQUEST_BYTES
    return cast("dict[str, object]", schema)


def contract_json_schemas() -> dict[ContractName, dict[str, object]]:
    """Return all ten provisional M23-08 schemas in ABI order."""
