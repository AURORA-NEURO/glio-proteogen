"""Canonical projections for the provisional M23-08 contract spine."""
...
def result_identifier(request_digest: Sha256Digest) -> str:
    """Return the deterministic M23-08 result identifier for a request digest."""

    return "gate.m2308." + request_digest.removeprefix("sha256:")
