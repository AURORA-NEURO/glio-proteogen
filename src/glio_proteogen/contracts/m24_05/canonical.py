"""Canonical projections for the provisional M24-05 contract spine."""
...
def result_identifier(value: BaseModel | dict[str, Any]) -> str:
    """Return a deterministic result identity derived from the request."""

    return "result." + canonical_request_digest(value).removeprefix("sha256:")
