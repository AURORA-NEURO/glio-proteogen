"""Canonical projections for the provisional M23-05 contract spine."""
...
def result_identifier(value: BaseModel | dict[str, Any]) -> str:
    """Derive the deterministic result identifier from the request payload."""

    return f"result.{canonical_request_digest(value).removeprefix('sha256:')}"
