"""Canonical projections for the provisional M25-02 contract spine."""
...
def result_identifier(request_digest: Sha256Digest) -> str:
    """Return the deterministic M25-02 result identifier for one request."""

    return "truth.m2502." + request_digest.removeprefix("sha256:")
