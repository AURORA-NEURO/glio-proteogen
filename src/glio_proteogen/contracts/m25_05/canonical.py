"""Canonical projections for the provisional M25-05 contract spine."""
...
def result_identifier(
    ...
    """Derive an immutable result identity from the exact request and terminal state."""

    return "m2505.result." + sha256_digest(
