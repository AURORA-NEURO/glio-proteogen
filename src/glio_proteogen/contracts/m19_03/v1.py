"""Provisional M19-03 fusion and aggregation engine contracts.

M19-03 owns component-specific integration beneath Immunopeptidomic evidence.
The contract preserves source identity, reliability, uncertainty, disagreement,
and ownership while abstaining on unsupported or unresolved inputs.
"""
...
# PROVISIONAL ABI: inferred solely from dossier lines 6604-6644.
M1903_MODULE_ID: Final = "GLIO-PROTEOGEN-M19-03"
M1903_OPERATION: Final = "fuse_proteotype_evidence"
M1903_CONTRACT_VERSION: Final = "0.1.0-provisional"
M1903_OUTPUT_MEDIA_TYPE: Final = "application/vnd.glio-proteogen.m19-03+json"
M1903_M1902_INPUT_MEDIA_TYPE: Final = "application/vnd.glio-proteogen.m19-02+json"
M1903_PARENT: Final = "proteotype"
M1903_OWNER: Final = "Quality engineering"
M1903_SAFETY_CLASS: Final = "S2"
M1903_GATE: Final = "G2"
M1903_PROVISIONAL_ABI: Final = True
M1903_DOSSIER_SHA256: Final = (
    "sha256:0a6b200cbe073db13a4bcf315edc23ab97edfe6f500bc7ea2785f5e1c70da181"
)
M1903_DOSSIER_SLICE: Final = "GLIO-PROTEOGEN_240_Module_Dossier.md:6604-6644"
M1903_MAX_CONTRIBUTIONS: Final = 128
M1903_MAX_DISAGREEMENTS: Final = 128
M1903_MAX_AGGREGATES: Final = 256
M1903_MAX_EVIDENCE: Final = 64
M1903_MAX_FINDINGS: Final = 64
M1903_MAX_CANONICAL_REQUEST_BYTES: Final = 4 * 1024 * 1024
M1903_MAX_CANONICAL_RESULT_BYTES: Final = 8 * 1024 * 1024
M1903_EVIDENCE_CLAIM: Final = (
...
class SourceKind(StrEnum):
    ...
    IMMUNOPEPTIDOMIC_EVIDENCE = "immunopeptidomic_evidence"
...
class SourceContribution(FrozenModel):
    ...
    evidence: tuple[EvidenceReference, ...] = Field(min_length=1, max_length=M1903_MAX_EVIDENCE)

    @model_validator(mode="after")
    def reliability_band_matches_score(self) -> SourceContribution:
        """Reject an optimistic band or a non-evaluable score declaration."""
...
class DisagreementRecord(FrozenModel):
    ...
    source_ids: tuple[Identifier, ...] = Field(min_length=2, max_length=M1903_MAX_CONTRIBUTIONS)
...
class AggregationConfiguration(FrozenModel):
    ...
    evidence: tuple[EvidenceReference, ...] = Field(default=(), max_length=M1903_MAX_EVIDENCE)
...
class IntegratedEvidenceObject(FrozenModel):
    ...
    contributions: tuple[SourceContribution, ...] = Field(
        min_length=1, max_length=M1903_MAX_CONTRIBUTIONS
    )
    disagreements: tuple[DisagreementRecord, ...] = Field(
        default=(), max_length=M1903_MAX_DISAGREEMENTS
    )
    aggregate_values: tuple[NonEmptyStr, ...] = Field(min_length=1, max_length=M1903_MAX_AGGREGATES)
...
class FuseProteotypeEvidenceRequest(FrozenModel):
    """Provisional request bound to the M19-02 alignment result."""

    operation: Literal["fuse_proteotype_evidence"] = M1903_OPERATION
    contract_version: Literal["0.1.0-provisional"] = M1903_CONTRACT_VERSION
    ...
    source_artifacts: tuple[ArtifactReference, ...] = Field(
        min_length=1, max_length=M1903_MAX_EVIDENCE
    )
    supersedes_result_digest: Sha256Digest | None = None

    @model_validator(mode="after")
    def request_is_bound(self) -> FuseProteotypeEvidenceRequest:
        if self.alignment_result.media_type != M1903_M1902_INPUT_MEDIA_TYPE:
            raise ValueError("request must bind the provisional M19-02 alignment result")
        source_ids = tuple(item.source_id for item in self.contributions)
        if len(source_ids) != len(set(source_ids)):
...
class ProteotypeIntegratedEvidenceResult(FrozenModel):
    """Integrated evidence result with explicit attribution and abstention."""

    output_type: Literal["proteotype_integrated_evidence"] = "proteotype_integrated_evidence"
    result_id: Identifier
    result_version: Literal["0.1.0-provisional"] = M1903_CONTRACT_VERSION
    request_digest: Sha256Digest
    result_digest: Sha256Digest
    request: FuseProteotypeEvidenceRequest
    status: FusionStatus
    integrated_evidence: IntegratedEvidenceObject | None = None
    findings: tuple[FusionFinding, ...] = Field(default=(), max_length=M1903_MAX_FINDINGS)
    abstention_reason: NonEmptyStr | None = None
    parent_target: Literal["proteotype"] = M1903_PARENT
    ...
    @model_validator(mode="after")
    def result_is_closed(self) -> ProteotypeIntegratedEvidenceResult:
...
__all__ = [
    ...
    "M1903_MAX_AGGREGATES",
    "M1903_MAX_CANONICAL_REQUEST_BYTES",
    "M1903_MAX_CANONICAL_RESULT_BYTES",
    "M1903_MAX_CONTRIBUTIONS",
    "M1903_MAX_DISAGREEMENTS",
    "M1903_MAX_EVIDENCE",
    "M1903_MAX_FINDINGS",
    "M1903_MODULE_ID",
    "M1903_OPERATION",
