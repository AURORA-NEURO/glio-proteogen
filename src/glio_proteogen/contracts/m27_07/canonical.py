"""Canonical projections for the provisional M27-07 contract spine."""
...
def result_identifier(request_digest: Sha256Digest) -> str:
    """Derive the stable change-control result identifier from its request."""

    return "result.m2707." + request_digest.removeprefix("sha256:")
