"""Canonical projections for the provisional M20-06 contract spine."""
...
def canonical_request_bytes(value: BaseModel | dict[str, Any]) -> bytes:
    """Return deterministic replay bytes for a request."""
...
def canonical_result_payload_bytes(value: BaseModel | dict[str, Any]) -> bytes:
    """Return deterministic replay bytes without the self-referential digest."""
