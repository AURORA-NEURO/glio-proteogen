"""JSON Schema 2020-12 exports for provisional M13-01 contracts."""
...
from glio_proteogen.contracts.m13_01.v1 import (
...
SCHEMA_ID_PREFIX: Final = "urn:aurora-neuro:glio-proteogen:GLIO-PROTEOGEN-M13-01:0.1.0-provisional"
CONTRACT_VERSION: Final = M1301_CONTRACT_VERSION
...
_CONTRACTS: Final = {
    ...
    "output": ProteotypeHypothesisRegistryResult,
...
def contract_json_schema(name: ContractName) -> dict[str, object]:
    """Return one strict, metadata-only provisional M13-01 schema."""

    schema = TypeAdapter(_CONTRACTS[name]).json_schema(mode="validation")
    schema["$schema"] = "https://json-schema.org/draft/2020-12/schema"
    schema["$id"] = f"{SCHEMA_ID_PREFIX}:{name}"
    schema["x-glio-contract"] = {
        "moduleId": M1301_MODULE_ID,
        "contractVersion": CONTRACT_VERSION,
        "owner": M1301_OWNER,
        "safetyClass": M1301_SAFETY_CLASS,
        "gate": M1301_GATE,
        "strict": True,
        "provisionalAbi": M1301_PROVISIONAL_ABI,
        ...
        "parentTarget": M1301_PARENT,
        "unsupportedToNegative": False,
        "outputMediaType": M1301_OUTPUT_MEDIA_TYPE,
    ...
    if name == "request":
        schema["x-glio-contract"]["maxRequestBytes"] = M1301_MAX_CANONICAL_REQUEST_BYTES
    return cast("dict[str, object]", schema)


def contract_json_schemas() -> dict[ContractName, dict[str, object]]:
    """Return all ten provisional M13-01 schemas in ABI order."""
