"""JSON Schema 2020-12 exports for provisional M23-01 contracts."""
...
from glio_proteogen.contracts.m23_01.v1 import (
...
SCHEMA_ID_PREFIX: Final = "urn:aurora-neuro:glio-proteogen:GLIO-PROTEOGEN-M23-01:0.1.0-provisional"
CONTRACT_VERSION: Final = M2301_CONTRACT_VERSION
...
_CONTRACTS: Final = {
    ...
    "output": VariantPeptideReferenceTruthResult,
...
def contract_json_schema(name: ContractName) -> dict[str, object]:
    """Return one strict, metadata-only provisional M23-01 schema."""

    schema = TypeAdapter(_CONTRACTS[name]).json_schema(mode="validation")
    schema["$schema"] = "https://json-schema.org/draft/2020-12/schema"
    schema["$id"] = f"{SCHEMA_ID_PREFIX}:{name}"
    schema["x-glio-contract"] = {
        "moduleId": M2301_MODULE_ID,
        "contractVersion": CONTRACT_VERSION,
        "owner": M2301_OWNER,
        "safetyClass": M2301_SAFETY_CLASS,
        "gate": M2301_GATE,
        "strict": True,
        "provisionalAbi": M2301_PROVISIONAL_ABI,
        ...
        "parentTarget": M2301_PARENT,
        "unsupportedToNegative": False,
        "outputMediaType": M2301_OUTPUT_MEDIA_TYPE,
    ...
    if name == "request":
        schema["x-glio-contract"]["maxRequestBytes"] = M2301_MAX_CANONICAL_REQUEST_BYTES
    return cast("dict[str, object]", schema)


def contract_json_schemas() -> dict[ContractName, dict[str, object]]:
    """Return all nine provisional M23-01 schemas in ABI order."""
