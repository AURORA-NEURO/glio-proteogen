"""Semantic canonicalization for the M03-08 protein-inference release closure."""
...
def normalized_manifest(manifest: BaseModel | dict[str, Any]) -> dict[str, Any]:
    ...
    # Stages are an ordered M03-01 -> M03-07 transformation chain and stay ordered.
...
def signing_statement_digest(  # noqa: PLR0913 - exact domain-separated statement.
    *,
    ...
    return sha256_digest(
        {
            "domain": "GLIO-PROTEOGEN-M03-08:protein-inference-release:v1",
            ...
            "support_route_result_digest": support_route_result_digest,
        }
    )
