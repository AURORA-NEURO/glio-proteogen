"""Provisional M11-04 network/state/mechanism inference contracts.

The M11-04 dossier requires a mechanism posterior or state estimate with
...
# PROVISIONAL ABI: inferred solely from the M11-04 dossier slice.
M1104_MODULE_ID: Final = "GLIO-PROTEOGEN-M11-04"
M1104_OPERATION: Final = "infer_variant_peptide_mechanism"
M1104_CONTRACT_VERSION: Final = "0.1.0-provisional"
M1104_OUTPUT_MEDIA_TYPE: Final = "application/vnd.glio-proteogen.m11-04+json"
M1104_M1101_RESULT_MEDIA_TYPE: Final = "application/vnd.glio-proteogen.m11-01+json"
M1104_PARENT: Final = "variant_peptide"
M1104_OWNER: Final = "Clinical science"
M1104_SAFETY_CLASS: Final = "S2"
M1104_GATE: Final = "G2"
M1104_PROVISIONAL_ABI: Final = True
M1104_MAX_ESTIMATES: Final = 512
M1104_MAX_ASSUMPTIONS: Final = 64
M1104_MAX_ALTERNATIVES: Final = 64
M1104_MAX_EVIDENCE: Final = 64
...
class MechanismEstimate(FrozenModel):
    ...
    assumptions: tuple[NonEmptyStr, ...] = Field(min_length=1, max_length=M1104_MAX_ASSUMPTIONS)
    alternatives: tuple[NonEmptyStr, ...] = Field(min_length=1, max_length=M1104_MAX_ALTERNATIVES)
...
class InferVariantPeptideMechanismRequest(FrozenModel):
    """Provisional request bound to the M11-01 hypothesis registry."""

    operation: Literal["infer_variant_peptide_mechanism"] = M1104_OPERATION
    contract_version: Literal["0.1.0-provisional"] = M1104_CONTRACT_VERSION
...
class VariantPeptideMechanismInferenceResult(FrozenModel):
    """Mechanism estimates with counter-evidence and explicit abstention."""

    output_type: Literal["variant_peptide_mechanism_inference"] = (
        "variant_peptide_mechanism_inference"
    )
    result_id: Identifier
    result_version: Literal["0.1.0-provisional"] = M1104_CONTRACT_VERSION
    request_digest: Sha256Digest
    result_digest: Sha256Digest
    request: InferVariantPeptideMechanismRequest
    status: MechanismInferenceStatus
    estimates: tuple[MechanismEstimate, ...] = Field(default=(), max_length=M1104_MAX_ESTIMATES)
    findings: tuple[MechanismFinding, ...] = Field(default=(), max_length=M1104_MAX_FINDINGS)
    abstention_reason: NonEmptyStr | None = None
    parent_target: Literal["variant_peptide"] = M1104_PARENT
...
def expected_provenance(
    ...
    return ProvenanceRecord(
        ...
        module_id=M1104_MODULE_ID,
        module_version=M1104_CONTRACT_VERSION,
