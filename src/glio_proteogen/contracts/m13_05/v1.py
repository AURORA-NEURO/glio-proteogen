...
M1305_MAX_EFFECT: Final = 20.0
M1305_DEFAULT_BOOTSTRAP_REPLICATES: Final = 64
M1305_MAX_BOOTSTRAP_REPLICATES: Final = 256
...
class TimePointObservation(FrozenModel):
    ...
    standardized_effect: float | None = Field(
        default=None, ge=-M1305_MAX_EFFECT, le=M1305_MAX_EFFECT
    )
    standard_error: float | None = Field(default=None, gt=0.0, le=M1305_MAX_EFFECT)
...
class EvolutionModelConfiguration(FrozenModel):
    ...
    bootstrap_replicates: int = Field(
        default=M1305_DEFAULT_BOOTSTRAP_REPLICATES,
        ge=16,
        le=M1305_MAX_BOOTSTRAP_REPLICATES,
    )
    evidence: tuple[EvidenceReference, ...] = Field(default=(), max_length=M1305_MAX_EVIDENCE)
...
class TrajectoryState(FrozenModel):
    ...
    lower_bound: float | None = Field(default=None, ge=-M1305_MAX_EFFECT, le=M1305_MAX_EFFECT)
    upper_bound: float | None = Field(default=None, ge=-M1305_MAX_EFFECT, le=M1305_MAX_EFFECT)
    evidence_count: int = Field(default=0, ge=0, le=M1305_MAX_OBSERVATIONS)
...
class ChangePoint(FrozenModel):
    ...
    evidence: tuple[EvidenceReference, ...] = Field(default=(), max_length=M1305_MAX_EVIDENCE)
    effect_delta: float | None = Field(default=None, ge=-M1305_MAX_EFFECT, le=M1305_MAX_EFFECT)
    lower_bound: float | None = Field(default=None, ge=-M1305_MAX_EFFECT, le=M1305_MAX_EFFECT)
    upper_bound: float | None = Field(default=None, ge=-M1305_MAX_EFFECT, le=M1305_MAX_EFFECT)
...
class LongitudinalDiagnostic(FrozenModel):
    ...
    solver_max_update: float | None = Field(default=None, ge=0.0, le=M1305_MAX_EFFECT)
...
__all__ = [
    ...
    "M1305_DEFAULT_BOOTSTRAP_REPLICATES",
    "M1305_GATE",
    "M1305_M1304_RESULT_MEDIA_TYPE",
    "M1305_MAX_BOOTSTRAP_REPLICATES",
