"""Canonical, input-order-invariant receipts for the phosphosite lane."""
...
if TYPE_CHECKING:
    from .contracts import LongitudinalGbmPhosphoRequest
...
def normalized_request(
    value: LongitudinalGbmPhosphoRequest | dict[str, Any],
) -> dict[str, Any]:
...
def canonical_request_digest(value: LongitudinalGbmPhosphoRequest | dict[str, Any]) -> str:
