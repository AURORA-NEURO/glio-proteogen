"""Canonical receipts for KNCC Reactome conditional-transition concordance."""
...
def normalized_request(
    value: LongitudinalGbmReactomeTransitionRequest | dict[str, Any],
) -> dict[str, Any]:
        ...
        time_points.append(
            {
                ...
                "normalization_reference_digest": time_point[
...
def result_payload_digest(
    value: LongitudinalGbmReactomeTransitionResult | BaseModel | dict[str, Any],
) -> str:
    document = _dump(value)
