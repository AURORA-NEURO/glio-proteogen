"""Canonical receipts for KNCC Reactome complex-member transitions."""
...
def normalized_request(
    value: LongitudinalGbmComplexTransitionRequest | dict[str, Any],
) -> dict[str, Any]:
    """Preserve time order while canonicalizing set-like observation arrays."""
...
def result_payload_digest(
    value: LongitudinalGbmComplexTransitionResult | BaseModel | dict[str, Any],
) -> str:
    document = _dump(value)
