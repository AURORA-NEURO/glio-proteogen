...
app.add_middleware(
    RequestSizeLimitMiddleware,
    max_bytes=M2003_MAX_CANONICAL_REQUEST_BYTES,
    result_max_bytes=M2003_MAX_CANONICAL_RESULT_BYTES,
)
...
def _load_request(path: Path) -> FuseProteinSubtypeEvidenceRequest:
    try:
        raw = read_bounded(path, M2003_MAX_CANONICAL_REQUEST_BYTES)
