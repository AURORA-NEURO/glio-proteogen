"""Verify internally consistent M23-07 release evidence and package identity."""
...
def main() -> int:
    ...
    parser.add_argument("--evidence-dir", type=Path, default=Path("release-evidence/m23_07"))
    ...
    try:
        ...
        print(f"M23-07 release verification failed: {error}", file=sys.stderr)
        return 1
    print("M23-07 release verification passed")
    return 0
