"""Verify M23-02 release-evidence manifests and optional package records."""
...
def verify(root: Path, wheel: Path | None = None, sdist: Path | None = None) -> dict[str, object]:
    """Verify manifest identity, evaluation, coverage, benchmark, and package evidence."""

    evidence = root / "release-evidence" / "m23_02"
    ...
    checks: dict[str, bool] = {
        ...
        "traceability": (root / "docs" / "traceability" / "M23-02.csv").is_file(),
        "module_documentation": (
            root / "docs" / "modules" / "M23-02-synthetic-truth-simulation-generator.md"
        ).is_file(),
    }
