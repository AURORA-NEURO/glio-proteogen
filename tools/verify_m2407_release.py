"""Verify M24-07 release evidence and reproducible package records."""
...
def verify(root: Path, wheel: Path | None = None, sdist: Path | None = None) -> dict[str, object]:
    """Return independent consistency checks for committed M24-07 evidence."""

    evidence = root / "release-evidence" / "m24_07"
    ...
    checks: dict[str, bool] = {
        ...
        and coverage.get("partial_branches") == 0,
    }
