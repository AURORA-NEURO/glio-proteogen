"""Verify M25-01 release-evidence manifests and package records."""
...
def verify(root: Path, wheel: Path | None = None, sdist: Path | None = None) -> dict[str, object]:
    """Return independent consistency checks for committed M25-01 evidence."""

    evidence = root / "release-evidence" / "m25_01"
    ...
    checks: dict[str, bool] = {
        ...
        "dependency": evaluation.get("upstream_dependency") == "none"
