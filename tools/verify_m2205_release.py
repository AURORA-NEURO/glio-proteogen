"""Verify M22-05 release-evidence manifests and package records."""
...
def verify(root: Path, wheel: Path | None = None, sdist: Path | None = None) -> dict[str, object]:
    evidence = root / "release-evidence" / "m22_05"
