"""Verify the M20-04 release-evidence manifest and package records."""
...
MODULE = "GLIO-PROTEOGEN-M20-04"
AUTHORITY = "sha256:0a6b200cbe073db13a4bcf315edc23ab97edfe6f500bc7ea2785f5e1c70da181"
SLICE = "GLIO-PROTEOGEN_240_Module_Dossier.md:7008-7048"


def verify(root: Path) -> dict[str, object]:
    evidence = root / "release-evidence" / "m20_04"
