"""Verify M16-04 release-evidence closure without network access."""
...
EVIDENCE: Final = ROOT / "release-evidence" / "m16_04"
FIXTURE: Final = ROOT / "tests" / "fixtures" / "m16_04" / "scenarios.json"
HISTORICAL_ARTIFACTS: Final = ROOT / "dist-m16-04"
EXPECTED_FIXTURE_DIGEST: Final = (
    "sha256:b328ab3685b39c81b431e41918164f943d43803594036c1e384bddc4c9323a9f"
)
...
def verify_release() -> dict[str, object]:
    ...
    _require(FIXTURE.exists(), "M16-04 fixture is missing")
    _require(_sha256(FIXTURE) == EXPECTED_FIXTURE_DIGEST, "fixture digest mismatch")
    _require(evaluation.get("module_id") == "GLIO-PROTEOGEN-M16-04", "evaluation module mismatch")
    _require(
        evaluation.get("fixture_digest") == EXPECTED_FIXTURE_DIGEST,
        "evaluation fixture mismatch",
    )
    _require(
    ...
    _require(
        benchmark.get("module_id") == "GLIO-PROTEOGEN-M16-04"
    ...
    traceability = ROOT / "docs" / "traceability" / "GLIO-PROTEOGEN-M16-04.csv"
    _require(
