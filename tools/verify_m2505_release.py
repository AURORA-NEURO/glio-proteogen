"""Verify M25-05 release-evidence manifests and package records."""
...
MODULE = "GLIO-PROTEOGEN-M25-05"
AUTHORITY = "sha256:0a6b200cbe073db13a4bcf315edc23ab97edfe6f500bc7ea2785f5e1c70da181"
SLICE = "GLIO-PROTEOGEN_240_Module_Dossier.md:8852-8892"
PARENT = "proteotype"
UPSTREAM = "GLIO-PROTEOGEN-M25-04 (provisional media only; ABI unfrozen)"
...
def verify(root: Path, wheel: Path | None = None, sdist: Path | None = None) -> dict[str, object]:
    """Return independent consistency checks for committed M25-05 evidence."""

    evidence = root / "release-evidence" / "m25_05"
