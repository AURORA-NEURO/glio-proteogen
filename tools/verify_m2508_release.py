"""Verify M25-08 release-evidence manifests and package records."""
...
MODULE = "GLIO-PROTEOGEN-M25-08"
AUTHORITY = "sha256:0a6b200cbe073db13a4bcf315edc23ab97edfe6f500bc7ea2785f5e1c70da181"
SLICE = "GLIO-PROTEOGEN_240_Module_Dossier.md:8984-9024"
PARENT = "proteotype"
UPSTREAM = "GLIO-PROTEOGEN-M25-07 (provisional media boundary)"
MEDIA_ONLY = "GLIO-PROTEOGEN-M25-06 (provisional media only; ABI unfrozen)"
...
def verify(root: Path, wheel: Path | None = None, sdist: Path | None = None) -> dict[str, object]:
    """Return independent consistency checks for committed M25-08 evidence."""

    evidence = root / "release-evidence" / "m25_08"
    ...
    checks: dict[str, bool] = {
        ...
        and evaluation.get("media_only_boundary") == MEDIA_ONLY
