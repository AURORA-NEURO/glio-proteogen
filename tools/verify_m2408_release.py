"""Verify the M24-08 release-evidence manifest and package records."""
...
MODULE = "GLIO-PROTEOGEN-M24-08"
AUTHORITY = "sha256:0a6b200cbe073db13a4bcf315edc23ab97edfe6f500bc7ea2785f5e1c70da181"
SLICE = "GLIO-PROTEOGEN_240_Module_Dossier.md:8580-8620"
FIXTURE_DIGEST = "sha256:6f449763dc1c095279e8b32948a515f218e27126438544c248d4716f9bb0aa9a"


def verify(root: Path) -> dict[str, object]:
    evidence = root / "release-evidence" / "m24_08"
    ...
    checks: dict[str, bool] = {
        ...
        "fixture": evaluation.get("fixture_digest") == FIXTURE_DIGEST,
