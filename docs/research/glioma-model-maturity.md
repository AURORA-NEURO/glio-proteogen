...
- `gbm-microenvironment-graph/1.0.0`: a source-locked Neftel-to-ECGI bridge
  ...
  standard-error floor before graph projection so model-score precision is not
  mistaken for cross-engine calibration; and
...
quality/standard-error weighted Huber IRLS with midpoint-median MAD scaling and
an objective-monotone scalar line search, preserves left-censored and
unsupported states, and detects molecular change
...
M06-04, M07-05, M08-03, M09-03, M09-04, M09-05, M09-06, M10-04, M10-05, M11-03, M11-04, M12-03, M12-04, M12-06, M13-04, M14-03, M14-05, M15-04, and M15-05 now have typed glioma
...
Initialization is censor-aware: repeated observations at a time point use a
deterministic inverse-variance, quality-weighted Huber/IRLS center projected
onto the tightest left-censor limits, while censor-only points start at the
...
stationary replay point. Initialization uses inverse-variance, quality-weighted
Huber centers for repeated assays while clamping to tightest censor limits;
...
observed centers use inverse-variance, quality-weighted Huber IRLS and are
...
or unsupported states. A frozen-parent damped Huber Jacobi fit combines temporal
...
2. **Broader GBM complex/pathway evidence graph.** The source-locked PDC000514
   ...
   follow-on multimodal factor stage now fits the exact Reactome complex panel
