# M23-03 internal benchmark and ablation

Status: provisional implementation; Scientific engineering owner review required.

M23-03 is a metadata-only internal benchmark and ablation boundary beneath
the variant-peptide parent. It accepts a caller-declared M23-02 synthetic-truth
...
emit a variant-peptide biological estimate or traverse scientific payloads.
...
is claimed. M23-02 is bound by its caller-declared media type only: this lane
does not import or assume an M23-02 runtime service.
