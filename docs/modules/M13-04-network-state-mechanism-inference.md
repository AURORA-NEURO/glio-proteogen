# GLIO-PROTEOGEN-M13-04 module manifest

| Property | Provisional locked value |
| --- | --- |
| Module | GLIO-PROTEOGEN-M13-04 |
| Responsibility | Network, state, or mechanism inference beneath Variant-peptide channel |
...
M13-04 lines 4488–4531. The dossier does not freeze endpoint names, wire media
...
M13-04 accepts only caller-declared references. It never opens raw proteome,
