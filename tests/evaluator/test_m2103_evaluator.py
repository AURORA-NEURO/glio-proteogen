...
import pytest
from evals.m21_03.benchmark import main as benchmark_main
from evals.m21_03.benchmark import run_benchmark
from evals.m21_03.evaluator import main as evaluator_main
...
def test_benchmark_rejects_non_positive_iterations(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    benchmark_main()
    evaluator_main()
    assert '"M21-03"' in capsys.readouterr().out
