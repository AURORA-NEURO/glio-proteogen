"""Evaluator and benchmark assertions for M17-04."""

from evals.m17_04.benchmark import run_benchmark
from evals.m17_04.run import evaluate


def test_m1704_evaluator_meets_adversarial_target() -> None:
    report = evaluate()
...
def test_m1704_benchmark_is_deterministic_and_within_budget() -> None:
