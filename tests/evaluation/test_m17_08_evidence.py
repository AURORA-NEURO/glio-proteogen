"""Evaluator and benchmark assertions for M17-08."""

from evals.m17_08.benchmark import run_benchmark
from evals.m17_08.run import evaluate


def test_m1708_evaluator_meets_adversarial_target() -> None:
    report = evaluate()
...
def test_m1708_benchmark_is_deterministic_and_within_budget() -> None:
