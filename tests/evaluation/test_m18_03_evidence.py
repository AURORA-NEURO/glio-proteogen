"""Evaluator and benchmark assertions for M18-03."""

from evals.m18_03.benchmark import run_benchmark
from evals.m18_03.run import evaluate


def test_m1803_evaluator_meets_adversarial_target() -> None:
    report = evaluate()
...
def test_m1803_benchmark_is_deterministic_and_within_budget() -> None:
