"""Evaluator and benchmark tests for provisional M25-02."""
...
import pytest
from evals.m25_02.benchmark import run_benchmark
from evals.m25_02.evaluator import run_evaluator
...
def test_evaluator_passes_all_declared_cases() -> None:
    ...
    assert report["module_id"] == "GLIO-PROTEOGEN-M25-02"
...
def test_evaluator_and_benchmark_entrypoints_execute() -> None:
    for module in ("evals.m25_02.evaluator", "evals.m25_02.benchmark"):
