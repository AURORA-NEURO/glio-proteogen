"""Executable M22-08 evaluator and benchmark checks."""

from evals.m22_08.benchmark import run_benchmark
from evals.m22_08.run import run_evaluator
...
def test_m22_08_evaluator_passes_all_frozen_cases() -> None:
...
def test_m22_08_benchmark_is_within_locked_budgets() -> None:
