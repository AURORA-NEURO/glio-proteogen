"""Evaluator and locked benchmark tests for provisional M23-05."""
...
from evals.m23_05.benchmark import run_benchmark
from evals.m23_05.evaluator import run_evaluator
...
def test_direct_evaluator_and_benchmark_entrypoints_bootstrap_project_root() -> None:
    ...
    evaluator = subprocess.run(  # noqa: S603 - fixed local evaluator entrypoint
        [sys.executable, str(root / "evals/m23_05/evaluator.py")],
        cwd=root,
        capture_output=True,
        text=True,
        check=True,
    ...
    benchmark = subprocess.run(  # noqa: S603 - fixed local benchmark entrypoint
        [sys.executable, str(root / "evals/m23_05/benchmark.py")],
        cwd=root,
        capture_output=True,
        text=True,
        check=True,
