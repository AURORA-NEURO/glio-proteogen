...
from evals.m24_03.benchmark import run_benchmark
from evals.m24_03.evaluator import run_evaluator

_EVALUATOR_SCENARIOS = 11
_BENCHMARK_ITERATIONS = 3


def test_m2403_evaluator_matrix_passes() -> None:
    report = run_evaluator()
    assert report["passed"] == report["scenario_count"] == _EVALUATOR_SCENARIOS


def test_m2403_locked_benchmark_passes() -> None:
