"""Locked M14-07 evaluator and benchmark evidence tests."""

# ruff: noqa: PLR2004

from evals.m14_07.benchmark import run_benchmark
from evals.m14_07.run import EXPECTED_CASE_IDS, run_evaluator


def test_m1407_evaluator_fixture_and_matrix_are_green() -> None:
...
def test_m1407_benchmark_respects_provisional_budget() -> None:
