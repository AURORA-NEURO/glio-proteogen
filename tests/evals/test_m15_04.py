"""Evaluator and benchmark checks for M15-04."""
...
import pytest
from evals.m15_04.benchmark import measure
from evals.m15_04.run import evaluate
...
def test_m1504_benchmark_stays_within_provisional_budgets() -> None:
...
def test_m1504_benchmark_rejects_nonpositive_iterations() -> None:
