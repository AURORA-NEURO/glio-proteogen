"""Executable M23-08 evaluator and benchmark checks."""

from evals.m23_08.benchmark import run_benchmark
from evals.m23_08.run import run_evaluator
...
def test_m23_08_evaluator_passes_all_frozen_cases() -> None:
...
def test_m23_08_benchmark_is_within_locked_budgets() -> None:
