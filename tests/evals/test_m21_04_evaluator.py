"""Executable M21-04 evaluator and benchmark checks."""

from evals.m21_04.benchmark import run_benchmark
from evals.m21_04.run import run_evaluator
...
def test_m21_04_evaluator_passes_all_frozen_cases() -> None:
...
def test_m21_04_benchmark_is_within_locked_budgets() -> None:
