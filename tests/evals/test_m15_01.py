"""Evaluator and benchmark checks for M15-01."""
...
import pytest
from evals.m15_01.benchmark import measure
from evals.m15_01.run import evaluate


def test_m1501_evaluator_matrix_passes() -> None:
    report = evaluate()
...
def test_m1501_benchmark_stays_within_provisional_budgets() -> None:
...
def test_m1501_benchmark_rejects_nonpositive_iterations() -> None:
