"""Evaluator and benchmark tests for M20-01."""
...
import pytest
from evals.m20_01 import benchmark, run
from evals.m20_01.benchmark import run_benchmark
from evals.m20_01.run import evaluate
...
def test_m20_01_evaluator_passes_declared_matrix() -> None:
    report = evaluate()
...
def test_m20_01_benchmark_is_deterministic_and_bounded() -> None:
...
def test_m20_01_command_entrypoints_write_reproducible_reports(tmp_path: Path) -> None:
...
def test_m20_01_scenario_builder_rejects_unknown_names() -> None:
    with pytest.raises(ValueError, match="unknown M20-01"):
