"""Transport-level request/result ceilings for the standalone M19 APIs."""
...
_REQUEST_CASES = (
    (m1901, "/v1/modules/M19-01/resolve", "M1901_MAX_CANONICAL_REQUEST_BYTES"),
    (m1902, "/v1/modules/M19-02/align", "M1902_MAX_CANONICAL_REQUEST_BYTES"),
    (m1905, "/v1/modules/M19-05/present", "M1905_MAX_CANONICAL_REQUEST_BYTES"),
)
_RESULT_CASES = tuple(
...
def test_m19_request_limit_is_enforced_before_body_parsing(
    module: Any,
    path: str,
    limit_name: str,
) -> None:
...
def test_m19_verify_result_limit_is_enforced_before_body_parsing(
    module: Any,
    path: str,
    limit_name: str,
) -> None:
