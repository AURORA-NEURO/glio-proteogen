"""Focused schema and deterministic-fixture smoke for provisional M22-02."""
...
def test_provisional_schemas_require_reproducible_truth_controls() -> None:
    ...
    for schema in schemas.values():
        ...
        assert metadata["upstreamInputMediaType"] == M2202_M2201_INPUT_MEDIA_TYPE
    assert schemas["output"]["x-glio-contract"]["outputMediaType"] == M2202_OUTPUT_MEDIA_TYPE
    assert M2202_PROVISIONAL_ABI is True
