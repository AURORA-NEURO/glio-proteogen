"""Focused contract/schema smoke for provisional M24-08."""
...
def test_provisional_schemas_preserve_biomarker_panel_gate_boundaries() -> None:
    ...
    assert all(
        schema["x-glio-contract"]["networkFactorHybridRequired"]
        and schema["x-glio-contract"]["bayesianModelAveragingAvailable"]
    ...
    assert schemas["output"]["x-glio-contract"]["outputMediaType"] == M2408_OUTPUT_MEDIA_TYPE
    assert M2408_PROVISIONAL_ABI is True
