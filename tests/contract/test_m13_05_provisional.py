"""Focused schema and temporal-ordering smoke for provisional M13-05."""
...
def test_provisional_schemas_are_strict_and_temporal() -> None:
    ...
    for schema in schemas.values():
        ...
        assert metadata["primaryArchitecture"] == "semi_supervised_classifier"
    assert schemas["output"]["x-glio-contract"]["outputMediaType"] == M1305_OUTPUT_MEDIA_TYPE
    assert M1305_M1304_RESULT_MEDIA_TYPE.endswith("m13-04+json")
    assert M1305_PROVISIONAL_ABI is True
