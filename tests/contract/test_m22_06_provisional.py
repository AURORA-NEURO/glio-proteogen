"""Focused schema and unsupported-abstention smoke for provisional M22-06."""
...
def test_provisional_schemas_require_robustness_and_safe_failure_controls() -> None:
    ...
    for schema in schemas.values():
        ...
        assert metadata["upstreamInputMediaType"] == M2206_M2205_INPUT_MEDIA_TYPE
    assert schemas["output"]["x-glio-contract"]["outputMediaType"] == M2206_OUTPUT_MEDIA_TYPE
    assert M2206_PROVISIONAL_ABI is True
