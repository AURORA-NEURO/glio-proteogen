...
def test_provisional_schemas_require_reproducible_truth_controls() -> None:
    ...
    for schema in schemas.values():
        ...
        assert metadata["upstreamInputMediaType"] == M2502_M2501_INPUT_MEDIA_TYPE
    assert schemas["output"]["x-glio-contract"]["outputMediaType"] == M2502_OUTPUT_MEDIA_TYPE
    assert M2502_PROVISIONAL_ABI is True
