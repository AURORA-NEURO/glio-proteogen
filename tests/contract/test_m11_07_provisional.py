"""Focused contract/schema smoke for provisional M11-07."""
...
def test_provisional_schemas_require_controls_and_conflict_preservation() -> None:
    ...
    assert schemas["output"]["x-glio-contract"]["outputMediaType"] == M1107_OUTPUT_MEDIA_TYPE
    assert M1107_PROVISIONAL_ABI is True
