"""Focused schema and temporal-ordering smoke for provisional M12-05."""
...
def test_provisional_schemas_are_strict_and_temporal() -> None:
    ...
    for schema in schemas.values():
        ...
        assert metadata["primaryArchitecture"] == "bayesian_nonparametric_subtype"
    assert schemas["output"]["x-glio-contract"]["outputMediaType"] == M1205_OUTPUT_MEDIA_TYPE
    assert M1205_M1204_RESULT_MEDIA_TYPE.endswith("m12-04+json")
    assert M1205_PROVISIONAL_ABI is True
