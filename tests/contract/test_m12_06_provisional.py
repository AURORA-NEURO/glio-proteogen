"""Focused schema and bounded-response smoke for provisional M12-06."""
...
def test_provisional_schemas_require_bounded_assumptions() -> None:
    ...
    assert schemas["output"]["x-glio-contract"]["outputMediaType"] == M1206_OUTPUT_MEDIA_TYPE
    assert M1206_PROVISIONAL_ABI is True
