"""Focused schema and automation-bias smoke for provisional M17-05."""
...
def test_provisional_schemas_require_safe_review_workspace_controls() -> None:
    ...
    assert schemas["output"]["x-glio-contract"]["outputMediaType"] == M1705_OUTPUT_MEDIA_TYPE
    assert M1705_PROVISIONAL_ABI is True
...
def test_default_ordering_is_safe() -> None:
