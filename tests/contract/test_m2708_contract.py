"""Focused contract/schema smoke for provisional M27-08."""
...
def test_provisional_schemas_preserve_retirement_boundaries() -> None:
    ...
    assert all(
        schema["x-glio-contract"]["baselineStackRequired"]
        and schema["x-glio-contract"]["networkFactorHybridFallback"]
        and schema["x-glio-contract"]["retirementCriteriaRequired"]
    ...
    assert schemas["output"]["x-glio-contract"]["outputMediaType"] == M2708_OUTPUT_MEDIA_TYPE
    assert M2708_PROVISIONAL_ABI is True
