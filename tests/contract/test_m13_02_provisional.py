"""Focused schema and safe-failure smoke for provisional M13-02."""
...
def test_provisional_schemas_preserve_proteotype_context_controls() -> None:
    ...
    assert schemas["output"]["x-glio-contract"]["outputMediaType"] == M1302_OUTPUT_MEDIA_TYPE
    assert M1302_PROVISIONAL_ABI is True
