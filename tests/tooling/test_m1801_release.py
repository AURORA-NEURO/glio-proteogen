"""Release-evidence verifier tests for M18-01."""
...
import pytest
from tools.verify_m1801_release import (
    M1801ReleaseEvidenceError,
    verify_benchmark,
    verify_coverage,
    verify_evaluation,
)

_EVIDENCE = Path(__file__).parents[2] / "release-evidence" / "m18_01"
...
def test_release_evidence_verifier_rejects_tampered_reports(
    ...
    with pytest.raises(M1801ReleaseEvidenceError):
        verifier(target)
