"""Adversarial tests for the M14-02 release evidence verifier."""
...
import pytest
from tools.verify_m1402_release import (
    CASE_IDS,
    FIXTURE_DIGEST,
    M1402ReleaseEvidenceError,
    verify_benchmark,
    verify_coverage,
    verify_evaluation,
    verify_package,
...
def test_verifiers_reject_tampering(tmp_path: Path) -> None:
    ...
    with pytest.raises(M1402ReleaseEvidenceError):
