"""Small deterministic benchmark wrapper for M15-04 release evidence."""
...
def measure(iterations: int = 10) -> dict[str, object]:
    ...
    for _ in range(iterations):
        ...
        if result.status.value != "inferred":
            raise RuntimeError("benchmark request did not infer a mechanism")
