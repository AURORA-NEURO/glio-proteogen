"""Bounded benchmark for the public M18-01 resolver operation."""
...
from glio_proteogen.contracts.m18_01 import M1801_MODULE_ID, CompatibilityStatus
...
def run_benchmark() -> BenchmarkReport:
    ...
    for _ in range(ITERATIONS):
        ...
        if result != warmup:
            raise RuntimeError("M18-01 benchmark result was not deterministic")  # noqa: TRY003
    ...
    return BenchmarkReport(
        ...
        timed_boundary="M1801Engine.resolve_only",
