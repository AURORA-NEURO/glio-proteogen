"""Benchmark the bounded M20-07 typed export workload."""
...
from glio_proteogen.contracts.m20_07 import M2007_MODULE_ID
from glio_proteogen.modules.c20_biomarker_panel.m20_07_downstream_typed_export import M2007Engine
...
def run_benchmark() -> BenchmarkReport:
    ...
    for _ in range(ITERATIONS):
        ...
        if result != warmup:
            raise RuntimeError("M20-07 benchmark result was not deterministic")  # noqa: TRY003
    ordered = sorted(samples)
    p95 = ordered[(95 * len(ordered) - 1) // 100]
    mean = fmean(samples)
    return BenchmarkReport(
        module_id=M2007_MODULE_ID,
        workload="bounded-consent-aware-protein-subtype-downstream-export",
