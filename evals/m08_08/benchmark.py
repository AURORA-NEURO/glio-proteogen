"""Deterministic benchmark for the M08-08 publishing boundary."""
...
def benchmark(iterations: int = DEFAULT_ITERATIONS) -> BenchmarkReport:
    ...
    request = _request("source.1", "source.2")
    ...
    for _ in range(iterations):
        ...
        if built.canonical_bytes != expected.canonical_bytes:
            raise RuntimeError("M08-08 result was not deterministic")  # noqa: TRY003
    ...
    return BenchmarkReport(
        ...
        workload="digest-bound evidence and explanation publication",
        timed_boundary="M0808EvidenceExplanationPublisher.publish",
        ...
        evidence_count=len(expected.result.evidence),
