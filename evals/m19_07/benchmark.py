"""Bounded benchmark for the M19-07 downstream typed export engine."""
...
def run_benchmark() -> BenchmarkReport:
    ...
    for _ in range(ITERATIONS):
        ...
        if result != warmup:
            raise RuntimeError("M19-07 benchmark result was not deterministic")  # noqa: TRY003
    ...
    return BenchmarkReport(
        ...
        workload="bounded_proteotype_downstream_typed_export",
        timed_boundary="M1907Engine.export_only",
