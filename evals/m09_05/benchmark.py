"""Deterministic benchmark for the M09-05 integration boundary."""
...
def benchmark(iterations: int = DEFAULT_ITERATIONS) -> BenchmarkReport:
    ...
    for _ in range(iterations):
        ...
        if built.canonical_bytes != expected.canonical_bytes:
            raise RuntimeError("M09-05 result was not deterministic")  # noqa: TRY003
    ...
    return BenchmarkReport(
        ...
        workload="hard and soft mechanism constraint integration",
        timed_boundary="M0905ConstraintIntegrator.integrate",
