"""Deterministic M11-07 evaluator over a frozen scenario matrix."""
...
from glio_proteogen.contracts.m11_07 import ControlOutcome
...
_FIXTURE = Path(__file__).parents[2] / "tests" / "fixtures" / "m11_07" / "scenarios.json"
_FIXTURE_SHA256: Final = "sha256:551b93ed5371820c247e23b1e4ecb3d9c6d1caa0c137874470a72e420839908c"


class _EvaluatorFixtureError(RuntimeError):
    def __init__(self, code: str) -> None:
        messages = {
            "digest": "M11-07 evaluator fixture digest mismatch",
            "cases": "M11-07 evaluator fixture cases are invalid",
            "case": "M11-07 evaluator case is invalid",
            "unknown": "unknown M11-07 evaluator case",
        }
...
def _execute_case(engine: M1107PlausibilityEngine, kind: str) -> tuple[str, str]:
    if kind == "supported":
