"""Small deterministic benchmark for the M06-05 integration boundary."""
...
def benchmark(iterations: int = DEFAULT_ITERATIONS) -> BenchmarkReport:
    ...
    for _ in range(iterations):
        ...
        if built.canonical_bytes != expected.canonical_bytes:
            raise RuntimeError("integration result was not deterministic")  # noqa: TRY003
    ...
    return BenchmarkReport(
        ...
        workload="single locked protein abundance constraint request",
        timed_boundary="M0605MechanismConstraintEngine.integrate",
