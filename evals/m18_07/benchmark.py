"""Bounded benchmark for the public M18-07 export adapter."""
...
def run_benchmark() -> BenchmarkReport:
    ...
    for _ in range(ITERATIONS):
        ...
        if result != warmup:
            raise RuntimeError("M18-07 benchmark result was not deterministic")  # noqa: TRY003
    ...
    return BenchmarkReport(
        ...
        workload="signed_supported_biomarker_panel_export",
        timed_boundary="M1807Engine.export_only",
