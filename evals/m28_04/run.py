"""Run the locked M28-04 gateway safety and determinism evaluator."""
...
from glio_proteogen.modules.c13_proteotype.m28_04_api_sdk_cli_gateway.plugin import (
    GatewaySubmission,
    M2804Plugin,
)

MODULE_ID: Final = "GLIO-PROTEOGEN-M28-04"
SCENARIO_ID: Final = "m2804.gateway.safety.v1"
...
def _tamper_rejected(result: object) -> bool:
    try:
        forged = result.model_copy(update={"result_id": "gateway.m2804.forged"})  # type: ignore[attr-defined]
        M2804GatewayEngine().replay(forged)
    except (M2804ReplayError, ValueError, TypeError):
        return True
    return False
