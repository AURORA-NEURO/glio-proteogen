"""Frozen, caller-declared M25-02 synthetic truth fixture."""
...
def build_request() -> GenerateProteotypeSyntheticTruthRequest:
    """Return the locked five-kind, ten-case fixture."""

    request_id = "m2402.fixture.request"
    upstream = _artifact("m2401.sensitivity", M2502_M2501_INPUT_MEDIA_TYPE)
...
def denied_request() -> GenerateProteotypeSyntheticTruthRequest:
