"""Deterministic evaluator for the M09-07 calibration/selective gates."""
...
def artifact(index: int, media_type: str = "application/json") -> ArtifactReference:
    return ArtifactReference(
        artifact_id=f"artifact.m0907.{index}",
        version="1.0.0",
...
def build_request(candidate: CalibrationCandidate | None = None) -> dict[str, object]:
    ...
    return {
        ...
        "context": context,
        "uncertainty_result": artifact(20, M0907_UNCERTAINTY_MEDIA_TYPE),
...
def run_evaluation() -> EvaluationReport:
    ...
    plugin = m0907.M0907Plugin(service)
