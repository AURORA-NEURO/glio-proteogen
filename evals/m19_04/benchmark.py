"""Bounded benchmark for the public M19-04 policy adapter engine."""
...
def run_benchmark() -> BenchmarkReport:
    ...
    for _ in range(ITERATIONS):
        ...
        if result != warmup:
            raise RuntimeError("M19-04 benchmark result was not deterministic")  # noqa: TRY003
    ...
    return BenchmarkReport(
        ...
        workload="bounded_proteotype_intended_use_policy_adaptation",
        timed_boundary="M1904Engine.adapt_only",
